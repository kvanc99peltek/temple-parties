    ...
    <div className="max-w-xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
      <div className="flex gap-2">
        <button
          ...
          className={`flex-1 py-2.5 sm:py-3 px-4 sm:px-6 font-bold text-base sm:text-lg rounded-[14px] border border-white/25 transition-all duration-200 font-montserrat ${
            selectedDay === 'friday'
